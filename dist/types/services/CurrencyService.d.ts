...
export declare class CurrencyService extends AbstractService {
    /**
     ...
     * ```
     */
    getLatestRates(base: string): Promise<ApiResponse>;
    /**
     ...
     * ```
     */
    getPairRate(base: string, target: string): Promise<ApiResponse>;
    /**
