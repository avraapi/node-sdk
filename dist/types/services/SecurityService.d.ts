...
export declare class SecurityService extends AbstractService {
    /**
     ...
     * ```
     */
    checkVpn(params: CheckVpnParams): Promise<ApiResponse>;
    /**
     ...
     * ```
     */
    checkBurnerEmail(params: CheckBurnerEmailParams): Promise<ApiResponse>;
}
