...
export declare class SmsService extends AbstractService {
    /**
     ...
     * ```
     */
    sendSingle(params: SendSingleParams): Promise<ApiResponse<SmsSendData>>;
    /**
     ...
     * ```
     */
    sendBulkSame(params: SendBulkSameParams): Promise<ApiResponse<SmsSendData>>;
    /**
     ...
     * ```
     */
    sendBulkDifferent(params: SendBulkDifferentParams): Promise<ApiResponse<SmsSendData>>;
    /**
     ...
     * ```
     */
    getBalance(): Promise<ApiResponse<SmsBalanceData>>;
}
